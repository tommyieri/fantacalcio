...
${playersData}
    ...
    function calcolaPianoCompletamento(st, candidato, asseg, mercato) {
          ...
          <tr class="bg-slate-950">
            <td colspan="7" class="p-3.5 border border-indigo-900/50 rounded-xl">
              \${pianoAperto?.id === p.id ? (pianoAperto.nonFattibile
                ...
                : \`<div class="mb-3 grid grid-cols-1 sm:grid-cols-3 gap-2 text-[11px] bg-indigo-950/35 border border-indigo-900/60 rounded-xl p-2.5">
                    ...
                    <p class="sm:col-span-3 text-[10px] text-slate-400">Calcolo esatto sugli slot rimasti: confronta questo acquisto con il miglior completamento della rosa ai prezzi live stimati. I fantapunti sono una proxy finche' non importiamo proiezioni storiche/calendario.</p>
                  </div>\`)
                : ''}
